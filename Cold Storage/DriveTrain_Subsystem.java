...
public class DriveTrain_Subsystem extends SubsystemBase {
    ...
    /* Left Motors */
    private final PWMVictorSPX m_left = new PWMVictorSPX(Constants.MOTOR_LEFTFRONT);                         // Left Front Motor using PWM Victor
    ...
    /* Right Motors */
    private final PWMVictorSPX m_right = new PWMVictorSPX(Constants.MOTOR_RIGHTFRONT);                        // Right Front Motor using PWM Victor
