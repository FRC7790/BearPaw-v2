...
public class Intake_Subsystem extends SubsystemBase {
   ...
   */
  private final PWMVictorSPX intake = new PWMVictorSPX(Constants.VICTORSPX_INTAKE);
  //private final VictorSPX intake_2 = new VictorSPX(Constants.VICTORSPX_INTAKE_2);

  private final DoubleSolenoid piston_1 = new DoubleSolenoid(Constants.DOUBLESOLENOID_1, Constants.DOUBLESOLENOID_1_REVERSE);
